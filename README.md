...
***Running the test case - classical way***
=======================
...
***Running the test case - with mitpack***
=======================
Mitpack is used to run all the tests of mitraillette at once, and to check their status easily.

To use it, for example for PRO_FILE.CY50T1:

1) Remove the path to the executable in the PRO_FILE (PRO_FILE.CY50T1) that you want to use.
2) From your directory with either your pack or your IAL-bundle, run mitpack --version CY50T1 --maxtime 40. You need to use maxtime on ecmwf cluster, where you are limited in the number of jobs that you can run simultaneously.
3) You can check the results with mitpack --status
4) For further informations : try perldoc mitpack
