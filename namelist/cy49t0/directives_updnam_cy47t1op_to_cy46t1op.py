...
## new_blocks = set(['NAMENSCOV','NAMFPOBJ','NAMNORGWD'])
...
keys_to_move = {('NAMTRAJ', 'LTRAJGP'):('NAMVAR', 'LTRAJGP'),
               }
...
# blocks_to_remove = set(['NAMJBHYBACV','NAMSATSIM','NAMTRAJ','NAMDVISI'])
 blocks_to_remove = {'NAMJBHYBACV','NAMSATSIM','NAMTRAJ',}
